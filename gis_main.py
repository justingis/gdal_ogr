...
def main():
     ...
     #my_schema = get_lyr_schema(r'/Users/justinhawley/repos/gdal_ogr/input/natural_gas.gdb','Natural_Gas_Processing_Plants', out_name = 'natural_gas_schema', out_path = '/Users/justinhawley/repos/gdal_ogr/output', out_format = 'csv', print_to_screen = True)
     
     #add_field_shp(r'/Users/justinhawley/Desktop/counties/centroids.shp', 'new_text_field', 'text')
     ...
     my_attributes = export_lyr_attributes(r'/Users/justinhawley/repos/gdal_ogr/input/natural_gas.gdb','Natural_Gas_Processing_Plants', fields = None, out_name = 'natural_gas_processing_plants', out_path = '/Users/justinhawley/repos/gdal_ogr/output', out_format = 'xlsx', print_to_screen = True)
